...
export default class JobSeekerProfilePage1 extends NavigationMixin(LightningElement) {
    ...
    handleSubmit(event){
        createJobSeekerRecord({firstname:this.firstname,lastname:this.lastname,dtDOB:this.dtDOB,coverLetter:this.coverLetter,experience:this.exp,email:this.email,Phone:this.Phone,jobLocation:this.jobLocation})
        .then(result => {
